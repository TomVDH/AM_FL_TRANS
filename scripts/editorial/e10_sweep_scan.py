#!/usr/bin/env python3
"""E10 canon sweep scanner — carries E9 ruleset unchanged.

E10 context (per §19 / §5.2):
- EpisodeTitle: short label cells
- Slow / Nice / Sad / Thirsty / Hard: register sub-tabs
- Government: institutional voice
- ProphetSpeech: Golden Ass / God-register (§7.4 — cap U/Uw)
- Words / Epilogue: Sturdy motto territory (§12.2 canonical 4-adj form)
- Credits: closing tab

All other patterns identical to E9 scanner.
"""
import re
import sys
...
XLSX = Path('excels.fresh-pull-2026-05-11/10_asses.masses_E10Proxy.xlsx')
DIARY_SHEETS = set()
