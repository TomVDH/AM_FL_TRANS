#!/usr/bin/env python3
"""E8 canon sweep scanner — carries E7 ruleset unchanged.

E8 context (per §19 / §5.2):
- SanctumMain: Hee/Haw/THE GODS speak; 8 cells have lowercase u/uw → cap U/Uw
- TheGods: God-register speakers throughout
- EpisodeTitle: short label cells

All other patterns identical to E7 scanner.
"""
import re
import sys
...
XLSX = Path('excels.fresh-pull-2026-05-11/8_asses.masses_E8Proxy.xlsx')
DIARY_SHEETS = set()
