...
export const InButtonGroup: Story = {
  render: () => (
    <div className="flex gap-2">
      <VideoButton />
      <button
        className="h-11 w-11 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600"
