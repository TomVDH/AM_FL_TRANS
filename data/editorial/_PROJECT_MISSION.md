...
| **Deviation surfacing format (codified 2026-04-28)** | When surfacing source-mirror deviations or any other rule violations for Tom's decision, use this format per item: **full file/sheet/cell ID** · **full EN string** · **full NL string** · **rule violated** · **context** · **two or more options (A/B/C)** · **your pick with reasoning**. No truncation of EN/NL. Tom needs the full strings to decide. |
